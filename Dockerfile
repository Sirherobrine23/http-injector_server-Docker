...
RUN apt update
RUN apt install -y squid3 dropbear openssh-server wget curl git unzip zip zsh sudo net-tools
RUN wget "https://github.com/AAAAAEXQOSyIpN2JZ0ehUQ/SSHPLUS-MANAGER-FREE/blob/master/Install/Sistema/Script/badvpn-udpgw?raw=true" -O /bin/badvpn-udpgw
